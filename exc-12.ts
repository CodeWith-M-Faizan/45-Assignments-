...
let my_Friends: string[] = ["Khalid", "Fawad", "Moin"];

console.log(`Hello ${my_Friends[0]}, How are you?`);
console.log(`Hello ${my_Friends[1]}, How are you?`);
console.log(`Hello ${my_Friends[2]}, How are you?`);